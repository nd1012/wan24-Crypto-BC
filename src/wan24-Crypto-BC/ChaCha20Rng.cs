namespace wan24.Crypto.BC
{
    ...
    public sealed class ChaCha20Rng(in ISeedableRng? rng = null, in int? bufferSize = null, in int? seedLength = 256)
        : StreamCipherRng(EncryptionChaCha20Algorithm.Instance, rng, bufferSize, seedLength)
    {
    }
}
