...
namespace wan24.Crypto.BC
{
    ...
    public abstract record class BouncyCastleAsymmetricPqcPrivateKeyBase<tPublic, tAlgo, tPublicKey, tPrivateKey, tFinal>
        ...
        protected override void DeserializeFullKeyData()
        {
            try
            {
                ...
                try
                {
                    ...
                    publicKey = (tPublicKey)PqcPublicKeyFactory.CreateKey(bufferSpan[..red].ToArray());
                    Keys = new(publicKey, privateKey);
                }
                catch
                {
