...
{
    /// <summary>
    /// Base class for a Bouncy Castle asymmetric public signature key
    /// </summary>
    ...
    public abstract record class BouncyCastleAsymmetricPublicSignatureKeyBase<tAlgo, tPublicKey, tSigner, tFinal>
        : BouncyCastleAsymmetricPublicKeyBase<tAlgo, tPublicKey, tFinal>, ISignaturePublicKey
        ...
        where tFinal : BouncyCastleAsymmetricPublicSignatureKeyBase<tAlgo, tPublicKey, tSigner, tFinal>, new()
    {
        /// <summary>
        /// Constructor
        /// </summary>
        protected BouncyCastleAsymmetricPublicSignatureKeyBase(string algorithm) : base(algorithm) { }
        ...
        protected BouncyCastleAsymmetricPublicSignatureKeyBase(string algorithm, byte[] keyData) : base(algorithm, keyData) => KeyData = new(keyData);
        ...
        protected BouncyCastleAsymmetricPublicSignatureKeyBase(string algorithm, tPublicKey publicKey) : base(algorithm, publicKey) { }
